  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-16 text-gray-800">
      <p className="mb-6  leading-relaxed">
        This website is operated by Quantum Wellness. Throughout the site, the
        terms “we”, “us” and “our” refer to Quantum Wellness. Quantum Wellness
      ...
      <p className="mb-10  leading-relaxed">
        Our store is hosted on WellnessLiving Systems Inc. They provide us with
      ...
      {/* 7 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">7. Optional Tools</h3>
      <p className="mb-6 leading-relaxed">
      ...
      {/* 8 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">8. Third-Party Links</h3>
      <p className=" mb-6 leading-relaxed">
      ...
      <p className="t mb-6 leading-relaxed">
      ...
      <p className="mb-6 leading-relaxed">
        ...
        third-party, including copyright, trademark, privacy, yogaity or other
      ...
      <p className="mb-6 leading-relaxed">
        YoYour submission of personal information through the store is governed
      ...
      {/* 12 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">12. Prohibited Uses</h3>
      <p className=" mb-6 leading-relaxed">
     In addition to other prohibitions as set forth in the Terms of Service, you are prohibited from using the site or its content: (a) for any unlawful purpose; (b) to solicit others to perform or participate in any unlawful acts; (c) to violate any international, federal, provincial or state regulations, rules, laws, or local ordinances; (d) to infringe upon or violate our intellectual property rights or the intellectual property rights of others; (e) to harass, abuse, insult, harm, defame, slander, disparage, intimidate, or discriminate based on gender, sexual orientation, religion, ethnicity, race, age, national origin, or disability; (f) to submit false or misleading information; (g) to upload or transmit viruses or any other type of malicious code that will or may be used in any way that will affect the functionality or operation of the Service or of any related website, other websites, or the Internet; (h) to collect or track the personal information of others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or immoral purpose; or (k) to interfere with or circumvent the security features of the Service or any related website, other websites, or the Internet. We reserve the right to terminate your use of the Service or any related website for violating any of the prohibited uses.
      ...
      <p className="mb-6 leading-relaxed">
       ...
       <p className="mb-6 leading-relaxed">
       In no case shall Quantum Wellness, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
      </p>

      {/* 14 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">14. Indemnification</h3>
      <p className="mb-6 leading-relaxed">
     You agree to indemnify, defend and hold harmless Quantum Wellness and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
      </p>

      {/* 15 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">15. Severability</h3>
      <p className=" mb-6 leading-relaxed">
   In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.
      </p>

      {/* 16 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">16. Termination</h3>
      <p className="mb-6 leading-relaxed">
   ...
   These Terms of Service are effective unless and until terminated by either you or us. You may terminate these Terms of Service at any time by notifying us that you no longer wish to use our Services, or when you cease using our site.
      ...
      {/* 17 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">17. Entire Agreement</h3>
      <p className="mb-6 leading-relaxed">
    The failure of us to exercise or enforce any right or provision of these Terms of Service shall not constitute a waiver of such right or provision.
     ...
     Any ambiguities in the interpretation of these Terms of Service shall not be construed against the drafting party.
      ...
      {/* 18 */}
      <h3 className="text-xl font-semibold mt-10 mb-3">18. Governing Law</h3>
      <p className=" mb-6 leading-relaxed">
    These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of 4200 SE 26th Terrace Road.
      </p>
    ...
    We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes. Your continued use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.
      ...
      <p className=" leading-relaxed">
        ...
        <a href="mailto:ryan@quantumwellnessusa.com" className="text-[#6F512D]"> ryan@quantumwellnessusa.com</a>
      </p>
    </section>
  );
}
