...
const page = () => {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            text: "40 minute treatments in the Ballancer Pro are equivalent to 2 days’ rest and recovery. Treatment recommendation is at least once per day and at minimum twice a day during high volume days",
          },
  ...
  return (
    <>
      ...
      <DeviceHero
        title="Ballancer Pro"
        image="/devices/devices-img/device-img-1.jpeg"
      />
      <DeviceSection
        title="Description"
        description={[
